...
import { createBlueDanwoong, createNavyDanwoong, getDanwoongParts } from "./danwoong-models.js?v=24";
...
export function mountDanwoongWalk() {
  ...
  function resize() {
    ...
    const wideDesktopPawCorrection = width > 1760
      ? Math.min(8, (width - 1760) * 0.05)
      : 0;
    const pawOffset = width <= 820 ? 0 : -4 - wideDesktopPawCorrection;
